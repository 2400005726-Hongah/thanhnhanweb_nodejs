  ...
  return (
    <div className="page-surface">
      ...
      <div className="container page-content">
        ...
        {requiredReady && <div className="filter-bar"><strong>Bộ lọc</strong><select className="form-select" name="busType" value={query.busType || ''} onChange={updateFilter} aria-label="Lọc loại xe"><option value="">Tất cả loại xe</option><option value="SLEEPER_34">Giường nằm 34 giường</option><option value="LIMOUSINE_22">Limousine 22 phòng</option><option value="SLEEPER">Giường nằm legacy</option><option value="LIMOUSINE">Limousine legacy</option><option value="SEATED">Ghế ngồi legacy</option></select><select className="form-select" name="departureTimeFrom" value={query.departureTimeFrom || ''} onChange={updateFilter} aria-label="Lọc giờ đi"><option value="">Mọi khung giờ</option><option value="06:00">Từ 06:00</option><option value="12:00">Từ 12:00</option><option value="18:00">Từ 18:00</option></select><select className="form-select" name="sort" value={query.sort || 'departureTimeAsc'} onChange={updateFilter} aria-label="Sắp xếp"><option value="departureTimeAsc">Giờ đi sớm nhất</option><option value="departureTimeDesc">Giờ đi muộn nhất</option><option value="priceAsc">Giá thấp đến cao</option><option value="priceDesc">Giá cao đến thấp</option></select></div>}
